...
{phang2}{cmd:. net install multe, from("https://raw.githubusercontent.com/timbulwidodostp/multe/main/multe") replace          }{p_end}
{phang2}{cmd:. import excel "https://raw.githubusercontent.com/timbulwidodostp/multe/main/multe/multe.xlsx", sheet("Sheet1") firstrow clear          }{p_end}
{phang2}{cmd:. multe std_iq_24 i.age_24 female [w=W2C0], treat(race) stratum(SES_quintile)                        }{p_end}
